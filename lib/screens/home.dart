    ...
    Container(
      ...
      decoration: BoxDecoration(
        ...
        image: new DecorationImage(
          image: new AssetImage("assets/pedillos.jpg"),
          //fit: BoxFit.none,
...
Row(
  children: [
    SizedBox(width: 25,),
    Text("Temas a tratar", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
  ],
),
SizedBox(height: 25,),
          Row(
            children: [
              ...
              Column(
                children: [
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: new DecorationImage(
                          ...
                          image: new AssetImage("assets/pngwing.com-2.png",  ),
                  ...
                  Text("Ansiedad",  style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                ],
              ),
              SizedBox(width: 15,),
              Column(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: new DecorationImage(
                        ...
                        image: new AssetImage("assets/pngwing.com-3.png",  ),
                  ...
                  Text("Depresion",  style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                ],
              ),
              SizedBox(width: 15,),
              Column(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: new DecorationImage(
                        ...
                        image: new AssetImage("assets/pngwing.com.png"),
                  ...
                  Text( isStrees ?  "estres": "no es estres",  style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                ],
              ),
            ],
          )
