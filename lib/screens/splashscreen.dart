...
class _SplashScreenState extends State<SplashScreen> {
  void initState() {
    ...
    super.initState();
    Timer(
      Duration(seconds:2), ()=>Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>OnBoardingScreen())),
    );
      ...
      body: Column(
        children: [
          ...
          Row(
            ...
            //  Image.asset("assets/doctorsplash.gif", height: 450.0, width: 400.0,),
          ...
          Row(
            children: [
              SizedBox(width: 110,),
              Text(" Hola! ", style: TextStyle(color: Color(0xFF929794), fontSize: 14),),
              Image.asset("assets/a7.png", height: 24, width: 24,),
